...
- Authentification par token (DRF `TokenAuthentication`, `IsAuthenticated` par défaut sur toute l'API)
- `django-cors-headers` pour les appels depuis Flutter web
...
Ses principales limites restantes sont l'absence de tests automatisés et l'agrégation du tableau de bord étudiant côté client.
